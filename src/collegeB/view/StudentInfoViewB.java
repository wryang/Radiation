...
import collegeB.controller.StudentInfoControllerB;

public class StudentInfoViewB {
	StudentInfoControllerB controller;
	JFrame infoFrame ;
	JPanel infoPanel;
	JTextField nameArea;
	...
	public StudentInfoViewB(StudentB currentStu,AdministerViewB adView){
		System.out.println("StudentInfoViewB");
		init();
		addActionListener();
		this.currentStu=currentStu;
//		System.out.println(currentStu.getStudentName());
		controller=new StudentInfoControllerB(this,currentStu);
		this.adView= adView;
	}
