...
import collegeC.controller.CourseInfoControllerC;

public class CourseInfoViewC {
	CourseInfoControllerC controller;
	JFrame infoFrame ;
	JPanel infoPanel;
	...
	public CourseInfoViewC(CourseC currentCourse,AdministerViewC adView){
		init();
		addActionListener();
		this.adView= adView;
		controller=new CourseInfoControllerC(this,currentCourse);
	}
